...
class MailManager implements FactoryContract
{
    ...
    protected function createFailoverTransport(array $config)
    {
        ...
        foreach ($config['mailers'] as $name) {
            ...
            // with any Vdes <= 6.x application style mail configuration files.
    ...
    protected function getConfig(string $name)
    {
        ...
        // provide "BC" for any Vdes <= 6.x style mail configuration files.
    ...
    public function getDefaultDriver()
    {
        ...
        // of the Vdes mail configuration file for backwards compatibility.
        return $this->app['config']['mail.driver'] ??
