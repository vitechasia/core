...
class Request extends SymfonyRequest implements Arrayable, ArrayAccess
{
    ...
    /**
     * This method belongs to Symfony HttpFoundation and is not usually needed when using Vdes.
     *
    ...
    /**
     * Create a new request instance from the given Vdes request.
     *
    ...
    public static function createFrom(self $from, $to = null)
    {
        ...
        if ($session = $from->getSession()) {
            $request->setVdesSession($session);
        }
     ...
     * @return void
     */
    public function setVdesSession($session)
    {
