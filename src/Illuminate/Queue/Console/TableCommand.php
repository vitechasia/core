...
class TableCommand extends Command
{
    ...
    {
        $table = $this->vdes['config']['queue.connections.database.table'];
    ...
    {
        return $this->vdes['migration.creator']->create(
            'create_'.$table.'_table', $this->vdes->databasePath().'/migrations'
        );
    }
